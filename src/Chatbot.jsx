...
export default function Chatbot({ services, onClose, onHighlight }) {
  ...
  const [recommendations, setRecommendations] = useState([]);   // first round
  const [recommendations2, setRecommendations2] = useState([]); // second round
      ...
      >
        <div className="chat-modal">
          ...
          <div className="chat-body" ref={bodyRef}>
            ...
            {step === STEP.GDPR && (
                <>
                  <RayBubble>
                    ...
                    <br /><br />
                    🔒 <strong>Privacy (AVG/GDPR):</strong> De informatie die je invult wordt alleen gebruikt om diensten te zoeken. Er worden <em>geen persoonsgegevens opgeslagen</em> — alles verdwijnt zodra je dit venster sluit.
                    <br /><br />
            ...
            {/* ── RESULTS (first round) ── */}
            {step >= STEP.RESULTS && step !== STEP.LOADING && (
                <>
            ...
            {step === STEP.FEEDBACK && (
                <>
                  <RayBubble style={{ marginTop: 14 }}>
                    ...
                    <br /><br />
                    <small>Wil je persoonlijk advies? Bel het Sociaal Wijkteam: <strong>{WIJKTEAM_PHONE}</strong></small>
                  </RayBubble>
            ...
            {/* ── SECOND RESULTS ── */}
            {(step === STEP.NEWRESULTS) && step !== STEP.LOADING2 && (
                <>
                  {apiError ? (
                      <RayBubble style={{ marginTop: 14 }}>
                        ⚠️ {apiError}
